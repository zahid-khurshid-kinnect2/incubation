        ...
        <!-- start slider -->
                    ...
                    <div id="main-slider" class="main-slider flexslider">
                        <ul class="slides">
                            ...
                            <li>
                                <img height="300" src="{{asset('local/public/template/img/slides/flexslider/slider-1.jpg')}}" alt="" />
                                <div class="flex-caption">
                                    <h3>IIC EMPOWERS</h3>
                            ...
                            <li>
                                <img height="300" src="{{asset('local/public/template/img/slides/flexslider/slider-2.jpg')}}" alt="" />
                                <div class="flex-caption">
                                    <h3>IIC GUIDES </h3>
                            ...
                            <li>
                                <img height="300" src="{{asset('local/public/template/img/slides/flexslider/slider-3.jpg')}}" alt="" />
                                <div class="flex-caption">
                                    <h3>IIC</h3>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-sm-6 col-lg-6">
                            ...
                            <h3>3.2.1 Business Planning & Awareness</h3>
